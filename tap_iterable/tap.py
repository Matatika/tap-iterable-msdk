...
class TapIterable(Tap):
    ...
    def discover_streams(self) -> list[streams.IterableStream]:
        return [
            ...
            streams.WhatsAppBounceStream(self),
            streams.WhatsAppClickStream(self),
            streams.WhatsAppReceivedStream(self),
            streams.WhatsAppSeenStream(self),
            streams.WhatsAppSendStream(self),
            streams.WhatsAppSendSkipStream(self),
